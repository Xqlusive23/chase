...
const ThankYou = () => {
    return (
      ...
      zIndex:9999
        ...
        <img src="/assets/chase2.png" alt="logo" className="w-80 mt-10"  />
      </div>

        <div className="container w-full sm:w-[60%] md:w-[60%] lg:w-[30%] mx-auto px-4">
      <div className="flex flex-col items-center justify-center space-y-4 p-3 rounded-md shadow-xl border border-gray-100">
        ...
        <h2 className='text-5xl font-semibold font-ui-sans-serif mb-6'>Thank You!</h2>
